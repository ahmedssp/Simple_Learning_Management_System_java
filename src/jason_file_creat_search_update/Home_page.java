...
import convertFiles_to_CSV.course_XML_TO_CSV;
import convertFiles_to_CSV.student_txt_to_CSV;
import jason_file_creat_search_update.*;
                       ...
                       while (PAGE1) {
                           ...
                           try {
                               ...
                               if  (C_ID.equals("b")) {PAGE1 = false;}
                                   ...
                                   course_enrollment.course_enroll("Out_Data/Student_course_details_Generated.json",studentId,C_ID);continue;}
                           }
                   ...
                   case "r": {
                       ...
                       while (po){
                           ...
                           if (!(c_d_r.contains(Json_Search.value_o))|| c_d_r.length()>=2){System.out.println("Invalid course Id!");continue;}
                               ...
                               System.out.println(Json_Search.value_o);
